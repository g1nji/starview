...
//                   console.log(i, row)
                  ...
                  $("<tr>")
                     .append($("<td>").html($(item).find("solYear").text() ) )
                     .append($("<td>").html($(item).find("solMonth").text() ) )
                     .append($("<td>").html($(item).find("solDay").text() ) )
                     .append($("<td>").html($(item).find("solWeek").text() ) )
                     .append($("<td>").html($(item).find("lunAge").text() ) )
                  .appendTo( $table )
